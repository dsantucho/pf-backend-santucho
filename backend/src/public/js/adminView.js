...
/* function render(data) {
  const html = data.map(elem => {
    return (`
    <div class=" w-full rounded overflow-hidden shadow-lg bg-white m-4">
        <div class="px-6 py-4">
        ...
        <button onclick="edit('${elem._id}')" class=" bg-red-600 m-3 text-white font-bold py-2 px-4 rounded">
        Editar Producto </button>
        <button onclick="deleteProduct('${elem._id}')" class=" bg-black m-3 text-white font-bold py-2 px-4 rounded">
